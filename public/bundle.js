...
class CommentsController {
  constructor(parentComponent, movieModel) {
    ...
    this._movieModel = movieModel;
    this._commentsComponent = new _components_comments__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _renderComment(commentModel) {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._commentsComponent.getElement(), commentComponent.getElement());
  }
  ...
  render(moviesModel) {
    ...
    const onClick = () => {
      ...
      moviesModel.slice(prevFilmsCount, showingFilmsCount).forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_1__["default"](movieModel, this._api).render(filmsListComponent);
      });
...
/* harmony import */ var _site_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./site-menu */ "./src/controllers/site-menu.js");
/* harmony import */ var _components_site_sort__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/site-sort */ "./src/components/site-sort.js");
...
class MainController {
  constructor(moviesModel, api) {
    ...
    this._siteSortComponent = new _components_site_sort__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._filmsComponent = new _components_films__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._filmsListController = new _films_list__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmsComponent, this._api);
    this._topRatesController = new _top_rates__WEBPACK_IMPORTED_MODULE_2__["default"](this._filmsComponent, this._api);
    this._mostCommentedController = new _most_commented__WEBPACK_IMPORTED_MODULE_3__["default"](this._filmsComponent, this._api);
  }

  siteSortRender(parentElement) {
    const siteSortElement = this._siteSortComponent.getElement();
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__["render"])(parentElement, siteSortElement);
  ...
  render(parentElement) {
    new _site_menu__WEBPACK_IMPORTED_MODULE_5__["default"](parentElement).render(this._moviesModel);
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_4__["render"])(parentElement, this._filmsComponent.getElement());
  ...
  render(moviesModel) {
    ...
    if (mostCommented[0].comments.length > 0) {
      mostCommented.forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_1__["default"](movieModel, this._api).render(mostCommentedComponent);
      });
...
/* harmony import */ var _models_comments__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../models/comments */ "./src/models/comments.js");
...
class MovieController {
  ...
  _submitDetailForm() {
    ...
    const comment = he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(formData.get(`comment`));
    const emoji = formData.get(`comment-emoji`);

    if (comment !== `` && emoji) {
      const commentModel = new _models_comment__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  _onOpenDetailsClick() {
    ...
    this._api.getComments(this._movieModel.id)
      .then(_models_comments__WEBPACK_IMPORTED_MODULE_7__["default"].parseComments)
      .then((comments) => {
        const commentsModel = new _models_comments__WEBPACK_IMPORTED_MODULE_7__["default"]();
        commentsModel.fillModel(comments);
        this._movieModel.comments = commentsModel;
        new _comments__WEBPACK_IMPORTED_MODULE_5__["default"](this._filmDetails, this._movieModel).render();
      });
  }
...
class PageController {
  ...
  render(parentComponent) {
    ...
    new _main__WEBPACK_IMPORTED_MODULE_1__["default"](this._moviesModel, this._api).render(parentComponent.querySelector(`.main`));
  ...
  render(moviesModel) {
    ...
    if (topRated[0].totalRating > 0) {
      topRated.forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_2__["default"](movieModel, this._api).render(topRates);
      });
...
/* harmony import */ var _controllers_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/page */ "./src/controllers/page.js");
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/movies */ "./src/models/movies.js");
...
const api = new _api__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);

const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_3__["default"]();

api.getMovies()
  .then(_models_movies__WEBPACK_IMPORTED_MODULE_3__["default"].parseMovies)
  .then((movies) => {
    moviesModel.fillModel(movies);
    new _controllers_page__WEBPACK_IMPORTED_MODULE_2__["default"](moviesModel, api).render(document);
  });
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: getFullDate, formatDateTime, RenderPosition, render, FilterType, SortType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
