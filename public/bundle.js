...
/***/ "./node_modules/coderain/coderain.js":
/*!*******************************************!*\
  !*** ./node_modules/coderain/coderain.js ***!
  \*******************************************/
/*! no static exports found */
...
class Provider {
  ...
  createComment(movieId, comment) {
    if (this._isOnLine()) {
      return this._api.createComment(movieId, comment).then(
          (newMovieModel) => {
            this._store.setItem(newMovieModel.id, newMovieModel.toRAW());
    ...
    const fakeNewMovieId = nanoid__WEBPACK_IMPORTED_MODULE_0___default()();
    const fakeNewMovie = _models_movies__WEBPACK_IMPORTED_MODULE_1__["default"].parseMovies(Object.assign({}, movieModel.toRAW(), {id: fakeNewMovieId}));

    this._isSynchronized = false;
    this._store.setItem(fakeNewMovie.id, Object.assign({}, fakeNewMovie.toRAW(), {offline: true}));
  ...
  updateMovie(id, task) {
    ...
    const fakeUpdatedMovie = _models_movies__WEBPACK_IMPORTED_MODULE_1__["default"].parseMovie(Object.assign({}, task.toRAW(), {id}));
  ...
  deleteMovie(id) {
    if (this._isOnLine()) {
      return this._api.deleteMovie(id).then(
          () => {
...
/* harmony import */ var _models_comments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/comments */ "./src/models/comments.js");
...
class CommentsController {
  constructor(parentComponent, movieModel, apiWithProvider) {
  ...
  _onDeleteButtonClick(commentId) {
    this._apiWithProvider.deleteComment(commentId)
      .then(() => {
        this._apiWithProvider.getComments(this._movieModel.id)
          .then(_models_comments__WEBPACK_IMPORTED_MODULE_3__["default"].parseComments)
          .then((comments) => {
            const commentsModel = new _models_comments__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
class FilmsListController {
  ...
  render(moviesModel) {
    ...
    const onClick = () => {
      ...
      moviesModel.slice(prevFilmsCount, showingFilmsCount).forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_1__["default"](movieModel, this._apiWithProvider).render(filmsListComponent);
      });
  ...
  _renderElement(containerElement, element, place = _utils__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND) {
    if (!this._filmsListComponent) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._parentComponent.getElement(), element, place);
    } else {
...
class MainController {
  constructor(moviesModel, apiWithProvider) {
    this._moviesModel = moviesModel;
    this._apiWithProvider = apiWithProvider;
    ...
    this._filmsListController = new _films_list__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmsComponent, this._apiWithProvider);
    this._topRatesController = new _top_rates__WEBPACK_IMPORTED_MODULE_2__["default"](this._filmsComponent, this._apiWithProvider);
    this._mostCommentedController = new _most_commented__WEBPACK_IMPORTED_MODULE_3__["default"](this._filmsComponent, this._apiWithProvider);
  ...
  render(parentElement) {
    new _site_menu__WEBPACK_IMPORTED_MODULE_6__["default"](parentElement).render(this._moviesModel);
  ...
  render(moviesModel) {
    ...
    if (mostCommented[0].comments.length > 0) {
      mostCommented.forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_1__["default"](movieModel, this._apiWithProvider).render(mostCommentedComponent);
      });

      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._parentComponent.getElement(), mostCommentedComponent.getElement());
    }
  }
}
...
class MovieController {
  constructor(movieModel, apiWithProvider) {
    this._movieModel = movieModel;
    this._apiWithProvider = apiWithProvider;
    ...
    this._commentsController = new _comments__WEBPACK_IMPORTED_MODULE_5__["default"](this._filmDetails, this._movieModel, this._apiWithProvider);
  ...
  _createComment() {
    ...
    if (commentText !== `` && emoji) {
      ...
      this._apiWithProvider.createComment(this._movieModel.id, localComment)
        ...
        .then(_models_comments__WEBPACK_IMPORTED_MODULE_6__["default"].parseComments)
        .then((comments) => {
  ...
  _onOpenDetailsClick() {
    ...
    this._apiWithProvider.getComments(this._movieModel.id)
      .then(_models_comments__WEBPACK_IMPORTED_MODULE_6__["default"].parseComments)
      .then((comments) => {
        const commentsModel = new _models_comments__WEBPACK_IMPORTED_MODULE_6__["default"]();
        commentsModel.fillModel(comments);
        this._movieModel.comments = commentsModel;
        this._commentsController.render();
      });
...
class PageController {
  ...
  render(parentComponent) {
    new _profile_rating__WEBPACK_IMPORTED_MODULE_0__["default"](this._moviesModel).render(parentComponent.querySelector(`.header`));

    new _main__WEBPACK_IMPORTED_MODULE_1__["default"](this._moviesModel, this._apiWithProvider).render(parentComponent.querySelector(`.main`));

    parentComponent.querySelector(`.footer__statistics`).replaceWith(new _components_footer_statistic__WEBPACK_IMPORTED_MODULE_2__["default"](this._moviesModel).getElement());
  }
}
...
class SiteMenuController {
  ...
  render(moviesModel) {
    ...
    const siteMenuComponent = new _components_site_menu__WEBPACK_IMPORTED_MODULE_1__["default"]();
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._parentElement, siteMenuComponent.getElement());
...
class StatisticController {
  ...
  render(parentElement) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_1__["render"])(parentElement, this._statisticComponent.getElement());
  }
  ...
  _renderChart(genres) {
    if (this._chart !== null) {
      ...
      this._chart = new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(this._statisticCanvasElement.getContext(`2d`), {
  ...
  _onFilterClick(evt) {
    switch (evt.target.value) {
      case _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterType"].TODAY:
        this._moviesModel.statisticFilterType = _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterPeriodName"].DAYS;
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterType"].WEEK:
        this._moviesModel.statisticFilterType = _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterPeriodName"].WEEKS;
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterType"].MONTH:
        this._moviesModel.statisticFilterType = _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterPeriodName"].MONTHS;
        break;
      case _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterType"].YEAR:
        this._moviesModel.statisticFilterType = _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterPeriodName"].YEARS;
        break;
      default:
        this._moviesModel.statisticFilterType = _utils__WEBPACK_IMPORTED_MODULE_1__["StatisticFilterPeriodName"].ALL_TIME;
        break;
    }
    this.update();
  }
...
class TopRatesController {
  ...
  render(moviesModel) {
    const topRates = new _components_top_rates__WEBPACK_IMPORTED_MODULE_1__["default"]();
    const topRated = moviesModel.getTopRated(TOP_RATED_FILMS_COUNT);

    if (topRated[0].totalRating > 0) {
      topRated.forEach((movieModel) => {
        new _movie__WEBPACK_IMPORTED_MODULE_2__["default"](movieModel, this._apiWithProvider).render(topRates);
      });

      Object(_utils__WEBPACK_IMPORTED_MODULE_0__["render"])(this._parentComponent.getElement(), topRates.getElement());
    }
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var coderain__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! coderain */ "./node_modules/coderain/coderain.js");
/* harmony import */ var coderain__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(coderain__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/movies */ "./src/models/movies.js");
...
const STORE_PREFIX = `sinemaddict-localstorage`;
const STORE_VER = `v1`;
const STORE_NAME = `${STORE_PREFIX}-${STORE_VER}`;
const AUTHORIZATION = `Basic ` + new coderain__WEBPACK_IMPORTED_MODULE_0___default.a(`###################`).next();
...
const api = new _api_api__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);
const store = new _api_store__WEBPACK_IMPORTED_MODULE_2__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_3__["default"](api, store);
console.log(store);
const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_5__["default"]();

apiWithProvider.getMovies()
  .then((movies) => {
    console.log(movies);
    moviesModel.fillModel(movies);
    new _controllers_page__WEBPACK_IMPORTED_MODULE_4__["default"](moviesModel, apiWithProvider).render(document);
  });
...
class MoviesModel {
  ...
  _statisticFilter() {
    ...
    return this._movies.filter((item) => {
      return (moment__WEBPACK_IMPORTED_MODULE_2___default()(item.watchingDate) >= targetDate && item.isAlreadyWatched);
    });
  }
  ...
  _filterMovies(movies) {
    switch (this._filterType) {
      ...
      case _utils__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL:
        return movies;
    }
    return movies;
  }
  ...
  _sortMovies(movies) {
    switch (this._sortType) {
      ...
      case _utils__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT:
        return movies;
    }
    return movies;
  }
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: getFullDate, formatDateTime, FilterType, SortType, RenderPosition, render, formatDuration, StatisticFilterType, StatisticFilterPeriodName */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
